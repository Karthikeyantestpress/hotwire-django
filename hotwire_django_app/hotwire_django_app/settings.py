"""
Django settings for hotwire_django_app project.
...
SECRET_KEY = 'django-insecure-%z2d#e!d&!in*+$tf(8xm=ede0uzorsld$(c%tpdnl5&6@09bw'
...
ROOT_URLCONF = 'hotwire_django_app.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['hotwire_django_app/templates'],  
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
